...
namespace LinkedData_Api.Controllers
{
    public partial class MainController : ControllerBase
    {
        ...
        [HttpGet("api/{endpoint}/class/{class_id?}/{subject?}/{predicate?}/{object?}")]
        public string Get_DefaultGraph_ClassStart([FromRoute] string endpoint, [FromRoute] string? class_id = null,
        ...
        [HttpGet("api/{endpoint}/resource/{object?}/{predicate?}/{subject?}")]
        ...
        [HttpGet("api/{endpoint}/{graph}/class/{class_id?}/{object?}/{predicate?}/{subject?}")]
        ...
        [HttpGet("api/{endpoint}/{graph}/resource/{object?}/{predicate?}/{subject?}")]
