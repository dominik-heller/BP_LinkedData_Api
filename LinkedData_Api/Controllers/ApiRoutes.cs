namespace LinkedData_Api.Controllers
{
    public static class ApiRoutes
    {
       ...
       // private const string ClassRecursivePart = "/{resource?}/{predicate?}/{r2?}/{p2?}/{r3?}/{p3?}/{r4?}";
        ...
        public const string DefaultGraphClassesConcreteResource = DefaultGraphConcreteClass + "/{resource"+regexConstraint+"}";
        public const string NamedGraphClassesConcreteResource = NamedGraphConcreteClass + "/{resource"+regexConstraint+"}";
        public const string DefaultGraphResourcesConcreteResource = DefaultGraphResources + "/{resource"+regexConstraint+"}";
        public const string NamedGraphResourcesConcreteResource = NamedGraphResources + "/{resource"+regexConstraint+"}";
        public const string DefaultGraphClassStartConcreteResourcePredicate = DefaultGraphClassesConcreteResource + "/{predicate"+regexConstraint+"}";
        public const string NamedGraphClassStartConcreteResourcePredicate = NamedGraphClassesConcreteResource + "/{predicate"+regexConstraint+"}";
        public const string DefaultGraphResourceStartConcreteResourcePredicate = DefaultGraphResourcesConcreteResource + "/{predicate"+regexConstraint+"}";
        public const string NamedGraphResourceStartConcreteResourcePredicate = NamedGraphResourcesConcreteResource + "/{predicate"+regexConstraint+"}";
