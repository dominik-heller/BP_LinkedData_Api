...
namespace LinkedData_Api.Controllers
{
    public partial class MainController : ControllerBase
    {
        ...
        [HttpPut("api/{endpoint}/class/{class_id?}/{subject?}/{predicate?}/{object?}")]
        ...
        [HttpPut("api/{endpoint}/resource/{object?}/{predicate?}/{subject?}")]
        ...
        [HttpPut("api/{endpoint}/{graph}/class/{class_id?}/{object?}/{predicate?}/{subject?}")]
        ...
        [HttpPut("api/{endpoint}/{graph}/resource/{object?}/{predicate?}/{subject?}")]
